...
class FlowExceptionHelperTest {
    ...
    void handleException_withContext_invokesHandlers() {
        FlowExceptionContext ctx = new FlowExceptionContext("job1", "e1", new RuntimeException("test invokesHandlers"), FlowPhase.PRODUCTION);
    ...
    void handleException_withParams_delegatesToContext() {
        assertDoesNotThrow(() ->
                FlowExceptionHelper.handleException("job1", "e1", new RuntimeException("test delegatesToContext"), FlowPhase.STORAGE));
    }
    ...
    void registerHandler_nonNull_added() {
        ...
        FlowExceptionHelper.handleException(new FlowExceptionContext("j", null, new RuntimeException("test registerHandler"), FlowPhase.UNKNOWN));
    ...
    void removeHandler_removesHandler() {
        ...
        FlowExceptionHelper.registerHandler(h);
        FlowExceptionHelper.removeHandler(h);
        assertDoesNotThrow(() -> FlowExceptionHelper.handleException("j", null, new RuntimeException("test removeHandler"), FlowPhase.UNKNOWN));
    }
    ...
    void setDefaultHandler_null_ignored() {
        ...
        assertDoesNotThrow(() -> FlowExceptionHelper.handleException("j", null, new RuntimeException("test setDefaultHandler null"), FlowPhase.UNKNOWN));
    }
    ...
    void setDefaultHandler_newHandler_notInList_addsIt() {
        ...
        assertDoesNotThrow(() -> FlowExceptionHelper.handleException("j", null, new RuntimeException("test setDefaultHandler adds"), FlowPhase.UNKNOWN));
    }
    ...
    void handlerThrowingException_doesNotBreakChain() {
        ...
        assertDoesNotThrow(() -> FlowExceptionHelper.handleException("j", null, new RuntimeException("test handler chain"), FlowPhase.UNKNOWN));
    }
    ...
    void handlerShouldHandleFalse_skipsHandle() {
        ...
        assertDoesNotThrow(() -> FlowExceptionHelper.handleException("j", null, new RuntimeException("test shouldHandle false"), FlowPhase.UNKNOWN));
    }

    @Test
    void clearHandlers_restoresDefaultOnly() {
        FlowExceptionHelper.clearHandlers();
        assertDoesNotThrow(() -> FlowExceptionHelper.handleException("j", null, new RuntimeException("test clearHandlers"), FlowPhase.UNKNOWN));
    }
}
