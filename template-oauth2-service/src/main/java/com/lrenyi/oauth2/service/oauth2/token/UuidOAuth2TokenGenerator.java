...
public class UuidOAuth2TokenGenerator implements OAuth2TokenGenerator<OAuth2AccessToken> {
    ...
    public OAuth2AccessToken generate(OAuth2TokenContext context) {
        if (!OAuth2TokenType.ACCESS_TOKEN.equals(context.getTokenType())
                || !OAuth2TokenFormat.REFERENCE.equals(context.getRegisteredClient()
                                                              .getTokenSettings()
     ...
     *
     * @param accessTokenCustomizer the {@link OAuth2TokenCustomizer} that customizes the claims
     *                              for the {@code OAuth2AccessToken}
     */
