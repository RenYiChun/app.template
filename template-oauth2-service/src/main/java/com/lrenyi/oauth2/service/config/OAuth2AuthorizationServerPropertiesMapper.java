...
public class OAuth2AuthorizationServerPropertiesMapper {
    ...
    private TokenSettings getTokenSettings(OAuth2AuthorizationServerProperties.Client client,
            PropertyMapper map) {
        ...
        map.from(token::getAccessTokenFormat)
           .as(OAuth2TokenFormat::new)
           .to(builder::accessTokenFormat);
