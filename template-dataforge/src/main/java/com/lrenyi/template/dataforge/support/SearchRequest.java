 ...
 */
public record SearchRequest(List<FilterCondition> filters, List<SortOrder> sort, int page, int size) {
    @JsonCreator
    public SearchRequest(@JsonProperty("filters") List<FilterCondition> filters,
