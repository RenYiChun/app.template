package com.lrenyi.template.entityplatform.controller;
...
import com.lrenyi.template.entityplatform.config.EntityPlatformProperties;
import com.lrenyi.template.entityplatform.meta.ActionMeta;
import com.lrenyi.template.entityplatform.meta.EntityMeta;
import com.lrenyi.template.entityplatform.registry.ActionRegistry;
import com.lrenyi.template.entityplatform.registry.EntityRegistry;
import com.lrenyi.template.entityplatform.service.EntityCrudService;
import com.lrenyi.template.entityplatform.support.EntityDtoResolver;
import com.lrenyi.template.entityplatform.support.ExcelExportSupport;
...
@org.springframework.web.bind.annotation.RequestMapping("${app.entity-platform.api-prefix:/api}")
public class GenericEntityController {
    ...
    public Result<?> executeAction(
        ...
        if (body != null && !body.isEmpty() && actionMeta.getRequestType() != null && actionMeta.getRequestType() != Void.class) {
    ...
    private List<?> toResponseList(EntityMeta meta, List<?> list) {
        ...
        if (responseDtoClass != null) {
            return list.stream()
                    .map(e -> objectMapper.convertValue(e, responseDtoClass))
