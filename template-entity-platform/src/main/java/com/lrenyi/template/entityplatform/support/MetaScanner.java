...
import com.lrenyi.template.entityplatform.annotation.ExportConverter;
import com.lrenyi.template.entityplatform.annotation.ExportExclude;
...
public class MetaScanner {
    ...
    private List<FieldMeta> buildFieldMetas(Class<?> clazz) {
        ...
        for (Field f : clazz.getDeclaredFields()) {
            ...
            fm.setPrimaryKey("id".equalsIgnoreCase(f.getName()) && (f.getType() == Long.class || f.getType() == long.class));
